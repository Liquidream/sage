  ...
  <v-app style="height: 100vh">
    ...
    <v-app-bar :elevation="2" :density="!isPortrait ? 'default' : 'compact'">
      ...
      <v-menu>
        ...
        <v-list>
          <v-list-item prepend-icon="mdi-link" @click="addSequence">
            Add Sequence
          </v-list-item>
    ...
    >
      <v-container id="mainContainer" class="pa-2">
        ...
        <SequenceProperties v-else-if="worldRefs.currSequenceId.value != ''" />
    ...
    <v-container v-if="isPortrait" style="overflow-y: scroll" class="pa-0">
      ...
      <v-container class="pa-4">
        ...
        <SequenceProperties v-else-if="worldStore.currSequenceId != ''" />
...
<script setup lang="ts">
  ...
  import SequenceProperties from "./components/SequenceProperties.vue"
  ...
  const addSequence = async () => {
    ...
    useWorldStore().createSequence(newSequence)
    // Now set it as current scene
    useWorldStore().currSequenceId = newSequence.id
    // Unselect scene/actor/prop/door, as changing sequence
    useWorldStore().currSceneId = ""
  ...
  const addScene = async () => {
    ...
    const newScene: SceneModel = {
      id: new_id,
      name: "New Scene",
      sequence_id: useWorldStore().currSequenceId,
      // Using the image file caused flicker (prob coz not using Assets?)
      image:
        "data:image/png;base64,",
      //image: "/images/scene-placeholder.png",
